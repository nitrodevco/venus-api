...
export class ItemBaseEntity
{
    ...
    @Column('double', { name: 'stack_height', precision: 4, scale: 2, default: '0.00' })
    ...
    @Column('tinyint', { name: 'allow_marketplace_sell', width: 1, default: '0' })
    public allowMarketplaceSell: boolean;

    @Column('tinyint', { name: 'allow_inventory_stack', width: 1, default: '1' })
    public allowInventoryStack: boolean;

    @Column('varchar', { name: 'interaction_type', length: 500, default: 'default' })
